...
BASE_DIR = '' # set this up before running this file
...
order_features = [value[1] for value in list(orderid_to_feat.items())]
...
ecommerce_hetero_graph.edges['rev-orders'].data['features'] = torch.stack(revorder_features, axis=0)
...
print("SAVE GRAPH !!")
dgl.save_graphs(f"{BASE_DIR}/graph_w_features/ecommerce_hetero_graph.dgl", [ecommerce_hetero_graph])
